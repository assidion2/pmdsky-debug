...
extern uint16_t OSI_TIMER_RESERVED;
extern undefined OSI_USE_TICK;
extern undefined OSI_USE_ALARM;
extern uint32_t FRAMES_SINCE_LAUNCH_TIMES_THREE;
extern uint32_t OSI_VRAM_EXCLUSIVE;
extern uint16_t OSI_VRAM_LOCK_ID[9];
extern struct alarm_callback_info CALLBACK_TABLE[8];
extern struct effect_control EFFECT_CONTROL;
